;; cl-stub-method-dispatch - A project template generated by ahungry-fleece
;; Copyright (C) 2016 Your Name <cl-stub-method-dispatch@example.com>
;;
...
;;;; cl-stub-method-dispatch.run.tests.lisp

(in-package #:cl-user)

(defpackage cl-stub-method-dispatch.run.tests
  (:use :cl
        :cl-stub-method-dispatch.lib.stub
        :af.lib.ansi-colors
        :af.lib.coverage
        :af.lib.testy)
  (:export :main))

(in-package #:cl-stub-method-dispatch.run.tests)

(defparameter *base-directory* (asdf:system-source-directory :cl-stub-method-dispatch))
...
(defun coverage ()
  ...
  (af.lib.coverage:with-coverage :cl-stub-method-dispatch
    (test)
    (terpri)
...
;;; "cl-stub-method-dispatch.run.tests" goes here. Hacks and glory await!
